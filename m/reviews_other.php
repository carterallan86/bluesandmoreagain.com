...
include('utils/connect_db.php');
	...
	$reviews_q="SELECT * FROM reviews WHERE category = 'Other' ORDER BY review_id DESC;";
...
<div id="site_content">
	...
	<div id="welcome">
	      <h2><a href="#">Other Reviews</a></h2>
	    </div><!--close welcome-->
		
        <div id="menu_items">
		<ul id="menu">
            <li><a href="reviews_album.php">Album</a></li>
            <li><a href="reviews_live.php">Live</a></li>
            <li><a href="reviews_book.php">Book</a></li>
            <li class="current"><a href="reviews_other.php">Other</a></li>
			</div><!--close menu-->
          </ul>
	  <div id="content">
