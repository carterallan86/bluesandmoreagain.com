...
include('utils/connect_db.php');
	...
	$reviews_q="SELECT * FROM reviews WHERE category = 'Book' ORDER BY review_id DESC;";
  ...
  <div id="main">
	...
	<div id="welcome">
	  ...
	  <div id="content">
        <div class="content_item">
			<p>“Every day I write the book” (Elvis Costello)<br>
			“You can’t judge a book by looking at the cover” (Bo Diddley)<br>
			“I ging to the lebry, I tak oot a book, and then I go hame for ma tea” (Michael Marra)<br>
			“Libraries give us power” (Manic Street Preachers)<br><br>
 
			Who am I to argue?<br><br>
			Books reviewed here.
			<br></p>
	...
	<div id="reviews">
		 	<div class="review_list">
			  ...
			  echo "<img ALIGN='Left' style='padding-right:30px' src='artwork_images/".$member['review_id'].".jpg',' width='200' height='300' alt='content image' />";
