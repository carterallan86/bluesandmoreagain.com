...
elseif ($_GET["security_code"] != "jumuhxxoy1i3eg3d6b79" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_1orq7";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=jumuhxxoy1i3eg3d6b79" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="31.170.164.98"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u532545362"></td></tr>
